    ...
    return (
        <div className='NumberGame'>
            ...
            */}
            ...
            {  isCorrect  ?  (<Link to='/game-twoStep'><button className='restart-button'>다음단계로이동</button></Link>)   :   (<button onClick={handleReStart} className='restart-button'>재시작버튼</button>)     }
